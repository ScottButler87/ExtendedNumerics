...
#define DESCRIBE_INT64_T_BENCHMARK_CALCULATION XSTR(2x multiplications of native integers)
  {
    TIME_BENCHMARK_OPERATION(FAST_OP_LOOPS_PER_SAMPLE, INT64_T_BENCHMARK_CALCULATION, DESCRIBE_INT64_T_BENCHMARK_CALCULATION, false)
  }
...
#define DESCRIBE_NUMERIC_FIXNUM_BENCHMARK_CALCULATION XSTR(multiplication of two fixnums resulting in a fixnum)
  {
    ...
    TIME_BENCHMARK_OPERATION(FAST_OP_LOOPS_PER_SAMPLE, NUMERIC_FIXNUM_BENCHMARK_CALCULATION, DESCRIBE_NUMERIC_FIXNUM_BENCHMARK_CALCULATION, false)
  }
...
#define DESCRIBE_NUMERIC_BIGNUM_BENCHMARK_CALCULATION XSTR(multiplication of two fixnums overflowing into a bignum)
  {
    ...
    TIME_BENCHMARK_OPERATION(MEDIUM_OP_LOOPS_PER_SAMPLE, NUMERIC_BIGNUM_BENCHMARK_CALCULATION, DESCRIBE_NUMERIC_BIGNUM_BENCHMARK_CALCULATION, false)
  }
