...
{\
  ...
  if (MAKE_VERBOSE) {\
    DEBUG_PRINT_OPERATION(OPERAND_TYPE##_left_base,  OPERAND_TYPE##_right_base, XSTR(BINARY_OP))\
    DEBUG_PRINT_OPERATION(OPERAND_TYPE##_left_2x,  OPERAND_TYPE##_right_2x, XSTR(BINARY_OP))\
    DEBUG_PRINT_OPERATION(OPERAND_TYPE##_left_4x,  OPERAND_TYPE##_right_4x, XSTR(BINARY_OP))\
    DEBUG_PRINT_OPERATION(OPERAND_TYPE##_left_8x,  OPERAND_TYPE##_right_8x, XSTR(BINARY_OP))\
    DEBUG_PRINT_OPERATION(OPERAND_TYPE##_left_16x,  OPERAND_TYPE##_right_16x, XSTR(BINARY_OP))\
  }\
