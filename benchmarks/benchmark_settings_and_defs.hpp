...
#define LARGE_TIME_UNITS seconds
  ...
  #define RANDOM_SEED_NUMBER 469078
#else
...
#define MAXIMUM_FIXNUM_BIT_SIZE 62
...
(static_cast<std::ostringstream&&>(std::ostringstream("") << std::fixed << std::setprecision(2) << TIME_PER_OPERATION\
